...
| 模型 | 实测结果 | 风险提醒 |
|---|---|---|
| `grok-imagine-image-quality` | 生图和编辑均已跑通 | 当前默认图片模型 |
...
请求时传 `size` 和 `resolution_name`，例如 `size=1280x720`、`resolution_name=720p`。`1920x1080`、`800x1200` 等任意自定义宽高当前不支持。
